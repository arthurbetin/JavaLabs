...
public class lab3_task1 extends JFrame {
    ...
    lab3_task1(String s, int w, int h) {
        ...
        Color textColor = new Color(150, 0, 0);

        JButton drawEllipse = new JButton("Намалюйте зелений ellipse");
        ...
        JButton drawTriangle = new JButton("Намалюйте блакитний equilateral triangle");
        ...
        JButton drawPentagon = new JButton("Намалюйте червоний pentagon");//8
